...
<body>
	<div id="container">
        ...
        <div id="main">
            ...
            <span class="navNormal">消息排名</span>
          ...
          <?php 
            ...
            $userdal = new UserDAL();
            $list = $userdal->getTopStatus(100);
            $count = 1;
            foreach ($list as $data) {
              $id = $data[0];
              $name = $data[1];
              $followers = $data[2];
              echo "<li>No.$count : <a href='http://fanfou.com/$id' target='_blank'>$name</a> ($followers 条消息)</li>";
              $count ++;
            }
