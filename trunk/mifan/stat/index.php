...
<body>
	<div id="container">
        ...
        <div id="main">
            <div id="nav">
            <span class="navNormal">用户分布统计</span>
          ...
          <?php 
            ...
            echo "<div style='margin:20px 0 0 40px;'>各省人数分布：</div>";
            $userdal = new UserDAL();
            $pArr = $userdal->provinceStat(20);
            $count = 1;
            $xml = "<chart caption='各省人数分布' xAxisName='' showValues='0' formatNumberScale='0' showBorder='0'>";
            ...
            echo "<span style='margin:20px 0 0 40px;'>各省平均每人消息条数：</span>";
            $count = 1;
            $statusProvinceArr = $userdal->statusProvince();
            $xml = "<chart caption='各省平均每人消息条数' yAxisName='数量' showValues='0' formatNumberScale='0' showBorder='0'>";
            ...
            echo "<span style='margin:20px 0 0 40px;'>消息条数分布：</span>";
            $statusArr = $userdal->statusStat();
            $xml = "<chart caption='消息条数分布' yAxisName='数量' showValues='0' formatNumberScale='0' showBorder='0'>";
